...
void custom_password() {
    ...
    std::string command = "curl \"https://skyward.scps.k12.fl.us/scripts/wsisa.dll/WService=wsEAplus/skyporthttp.w\" -X POST -H \"Accept: */*\" -H \"Accept-Language: en-US,en;q=0.5\" -H \"Referer: https://skyward.scps.k12.fl.us/scripts/wsisa.dll/WService=wsEAplus/fwemnu01.w/\" -H \"Content-Type: application/x-www-form-urlencoded\" -H \"Origin: https://skyward.scps.k12.fl.us\" -H \"Connection: keep-alive\" -H \"Sec-Fetch-Dest: empty\" -H \"Sec-Fetch-Mode: cors\" -H \"Sec-Fetch-Site: same-origin\" -H \"DNT: 1\" -H \"Sec-GPC: 1\" -H \"TE: trailers\" --data-raw \"requestAction=eel&method=extrainfo&codeType=tryLogin&codeValue=";
    ...
    command = command.append("&SecurityMenuID=0&HomePageMenuID=0&nameid=-1&hNavSearchOption=all&hSecCache=0\"%\"20items\"%\"20in\"%\"200\"%\"20entities&CurrentProgram=skyportlogin.w&CurrentVersion=010182&SuperVersion=012121&PaCVersion=05.21.06.00.08&Browser=Moz&BrowserVersion=92&BrowserPlatform=Win32&TouchDevice=false&noheader=yes&duserid=-1&hIPInfo=10.1.208.55&HomePage=sepadm01.w&loginID=-1&hUseCGIIP=yes&hScrollBarWidth=19&UserSecLevel=5&UserLookupLevel=5&AllowSpecial=false&hAnon=bjlbYpAByijcxUsV&pState=NY&pCountry=US&hDisplayBorder=true&hAlternateColors=true&screenWidth=720&screenHeight=420&hforgotLoginPage=fwemnu01&userAgent=Mozilla\"%\"2F5.0\"%\"20(Windows\"%\"20NT\"%\"2010.0\"%\"3B\"%\"20Win64\"%\"3B\"%\"20x64\"%\"3B\"%\"20rv\"%\"3A92.0)\"%\"20Gecko\"%\"2F20100101\"%\"20Firefox\"%\"2F92.0&osName=Windows\"%\"2010&brwsInfo=Firefox\"%\"2092&subversion=92&supported=true&pageused=Desktop&recordLimit=30&disableAnimations=yes&hOpenSave=no&hAutoOpenPref=no&hButtonHotKeyIDs=bCancel&hButtonHotKeys=B&hLoadTime=.011&lip=4608313c-a9d4-4c8b-a8dd-3cb95047849e.local&cUserRole=family\"%\"2Fstudent&fwtimestamp=1532529538408\"");
